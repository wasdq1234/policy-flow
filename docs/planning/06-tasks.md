...
### Phase 0 (main 브랜치)
- [ ] T0.1: 프로젝트 초기화 및 모노레포 구조 생성
- [ ] T0.2: Cloudflare D1 데이터베이스 설정
- [ ] T0.3: 프론트엔드 기본 레이아웃 및 라우팅
- [ ] T0.4: 백엔드 Hono 기본 구조 및 미들웨어
- [ ] T0.5.1: API 계약 정의 (Contracts)
- [ ] T0.5.2: 백엔드 테스트 프레임워크 설정
- [ ] T0.5.3: 프론트엔드 테스트 프레임워크 설정
